...
completed, and `storage:link` correctly reported that the normal link already
existed because the API entrypoint creates it. No seed or administrator was
created by Compose startup.
