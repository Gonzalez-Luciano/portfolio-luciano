...
final class ProjectFactory extends Factory
{
    ...
    {
        return ['key' => 'synthetic-project-'.$this->faker->unique()->numerify('###'), 'key_locked' => false, 'position' => 0, 'title_es' => null, 'title_en' => null, 'summary_es' => null, 'summary_en' => null, 'problem_es' => null, 'problem_en' => null, 'solution_es' => null, 'solution_en' => null, 'featured' => false, 'demo_url' => null, 'repository_url' => null, 'status' => PublicationStatus::Draft, 'is_visible' => false, 'published_at' => null];
    }
    ...
    {
        return ['key_locked' => true, 'title_es' => 'Proyecto técnico sintético', 'title_en' => 'Synthetic technical project', 'summary_es' => 'Resumen técnico sintético.', 'summary_en' => 'Synthetic technical summary.', 'problem_es' => 'Problema técnico sintético.', 'problem_en' => 'Synthetic technical problem.', 'solution_es' => 'Solución técnica sintética.', 'solution_en' => 'Synthetic technical solution.', 'status' => PublicationStatus::Published, 'is_visible' => $visible, 'published_at' => now()];
    }
}
