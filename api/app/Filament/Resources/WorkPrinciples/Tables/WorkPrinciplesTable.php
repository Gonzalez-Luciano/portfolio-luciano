...
namespace App\Filament\Resources\WorkPrinciples\Tables;
    ...
    public static function configure(Table $table): Table
    {
        return $table
            ...
            ->columns([
                ...
                TextColumn::make('statement_es')->label('Statement (ES)')->limit(60),
                TextColumn::make('statement_en')->label('Statement (EN)')->limit(60),
