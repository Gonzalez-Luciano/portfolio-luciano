...
namespace App\Filament\Resources\WorkCases\Tables;
    ...
    public static function configure(Table $table): Table
    {
        return $table
            ...
            ->columns([
                ...
                TextColumn::make('title_es')->label('Title (ES)')->limit(40),
                TextColumn::make('title_en')->label('Title (EN)')->limit(40),
