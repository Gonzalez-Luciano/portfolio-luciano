...
namespace App\Filament\Resources\ProfessionalLinks\Tables;
    ...
    public static function configure(Table $table): Table
    {
        return $table
            ...
            ->columns([
                ...
                TextColumn::make('label_es')->label('Label (ES)')->limit(40),
                TextColumn::make('label_en')->label('Label (EN)')->limit(40),
                TextColumn::make('destination')->label('Destination')->limit(40),
