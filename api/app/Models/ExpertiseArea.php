...
final class ExpertiseArea extends Model
{
    use HasFactory;

    protected $fillable = ['key', 'key_locked', 'position', 'title_es', 'title_en', 'description_es', 'description_en', 'status', 'is_visible', 'published_at'];
